...
namespace MongoDB.Driver.Core.Events
{
    ...
    public struct ClusterSelectedServerEvent
    {
        ...
        public ClusterSelectedServerEvent(ClusterId clusterId, ClusterDescription clusterDescription, IServerSelector serverSelector, ServerDescription selectedServer, TimeSpan elapsed)
        {

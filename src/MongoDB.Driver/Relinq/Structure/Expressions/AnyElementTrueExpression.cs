...
{
    internal class AnyElementTrueExpression : MongoExpression
    {
        private readonly string _itemName;
        private readonly Expression _predicate;
        private readonly Expression _source;

        public AnyElementTrueExpression(Expression source, string itemName, Expression predicate)
        {
        ...
        {
            get { return MongoExpressionType.AnyElementTrue; }
        }
        ...
        {
            return visitor.VisitAnyElementTrue(this);
        }
    }
}

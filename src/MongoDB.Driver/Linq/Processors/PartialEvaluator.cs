...
namespace MongoDB.Driver.Linq.Processors
{
    internal static class PartialEvaluator
    {
        ...
        {
            // any non-native expression type cannot be done locally
            if (expression is LinqToMongoExpression)
            {
                return false;
            }
        ...
        /// </summary>
        private class SubtreeEvaluator : LinqToMongoExpressionVisitor
        {

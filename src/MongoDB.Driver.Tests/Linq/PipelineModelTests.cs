...
namespace MongoDB.Driver.Tests.Linq
{
    ...
    public class PipelineModelTests : LinqTestBase
    {
        ...
        public void SetUp()
        {
            ...
            collection.Save(new ZipInfo { State = "SA", City = "SAC1", ZipCode = "SAC1Z1", Pop = 10 });
            collection.Save(new ZipInfo { State = "SA", City = "SAC1", ZipCode = "SAC1Z2", Pop = 20 });
            collection.Save(new ZipInfo { State = "SA", City = "SAC2", ZipCode = "SAC2Z1", Pop = 100 });
            collection.Save(new ZipInfo { State = "SB", City = "SBC1", ZipCode = "SBC1Z1", Pop = 10 });
            collection.Save(new ZipInfo { State = "SB", City = "SBC2", ZipCode = "SBC2Z1", Pop = 20 });
        }
